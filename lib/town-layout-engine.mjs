...
export function sampledEdgePoints(layout, startVertexId, endVertexId) {
  const generation = generationFor(layout);
...
export function resolveDistrictPolygon(layout, vertexIds) {
  const points = [];
...
export function resolveTownLayout(layout) {
  return {
    ...layout,
    townFootprintPath: layout.townFootprintPath ?? layout.shoreWallPath,
