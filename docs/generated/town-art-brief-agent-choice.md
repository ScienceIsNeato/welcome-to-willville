# Willville Art Brief (Agent's Choice)

Profile: `agent-choice`

Let the coding agent choose available local/image-generation tooling and integrate produced assets directly.
